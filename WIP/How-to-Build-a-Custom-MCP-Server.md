...
Let me give you a simple example: Suppose you go to Claude and ask, _"Who am I?"_ Will it be able to answer that? No, it won't. But if in a previous message you had told Claude, _"Hey, I'm Sumit"_ and then later in the same session ask _"Who am I?"_, it will say, _"You're Sumit."_ Why? Because now it has context.
...
It’s like going to Claude Desktop and telling it, _“Hey, I’m Sumit!”_ and then asking "_Who am I?_". Again, it’ll know because you told it before.
...
![Model Context Protocol - Structured Communication](how-to-build/c0c8c59d-5c2c-451e-9649-0889cae36c05.png)
...
Let's call it an **MCP server**. If you connect your MCP server to Cursor, then here's what happens: Cursor still can't access your files directly. But now, when you ask it a question, it will turn to this MCP server and say: "_Hey, do you know anything about this?_" And the MCP server – since you've built it to connect with your files or databases – will fetch the relevant information, turn it into context, and feed that back to the model. Now the model has the necessary background to generate a smart, informed reply.
...
![How MCP Server communicates with Local Data and generate Response](how-to-build/7244b0ee-f015-48f2-9433-2cf29a194b06.jpg)

Say you ask Cursor: "_Do I have any meetings today?_" Now to answer that, the AI would need access to your schedule, right? Let's say you use Google Calendar to manage your meetings. Can Cursor directly connect to your Google Calendar? No, it can't. And not just Cursor – ChatGPT or Claude can't access your calendar either, not unless you manually build that integration.
...
![How MCP feeds context to Cursor Editor](how-to-build/0955d5b2-48ce-4e12-877b-0eeb7d2ddad2.png)
...
Let me give you another solid example. Suppose you want to connect your GitHub to Cursor. You want to say something like: "_Hey, push my code to GitHub_" – and it just works. To make that happen without MCP, what would you normally need to do? You'd have to:
...
![USB-C universal connector analogy](how-to-build/7df559c2-48bf-4a39-8415-31276609ca98.jpg)
...
Let me walk you through one more example just to help you really get this. Imagine you're using Claude. You ask it a simple question: “_Do I have a meeting today?"_
...
![Claude vague answer without MCP](how-to-build/c1cecbfc-1012-4580-ba95-ccfeb0854129.png)
...
_"Hey, what are your capabilities?"_

Because your MCP server might be able to do many things. Maybe it can:

So the model first figures out:

_"Which of these capabilities do I need?"_

In this case, it decides:

_"Okay, I just need to know if the user has a meeting today."_
...
_"Here's the date. Tell me if the user has a meeting."_
...
_"Yes, you have a meeting with Dr. Chuck at 4 PM."_

![Claude positive answer with MCP Server](how-to-build/efa2637d-1a35-4f7a-b8f6-2d9183580c23.png)
...
![MCP local transport process similar to REST API](how-to-build/9f22b8a9-9c56-45cc-95ae-5b946e379133.jpg)
...
_"Alright, I should call the_ `calendar` _method."_
...
_"Yes, you have a meeting 'Team Sync' today at 4 PM."_
...
[![MCP architecture diagram from the docs](how-to-build/9d07577d-447e-4a13-b205-1d0e72b5d18a.png)](https://modelcontextprotocol.io/introduction)
...
![MCP components talk to each other](how-to-build/bd68a3f8-7bf3-4fcc-b631-c99a4ea05667.png)
...
_"What are the pricing plans for logicBase Labs?"_
...
![How to connect MCP Server in cursor](how-to-build/14ac470e-38e7-4cf4-bef8-823fc155c015.png)
...
![How to connect MCP Server in Cursor](how-to-build/9a07465a-0e7b-4bb7-9523-286dcf38373a.png)
...
_"Do I have any meetings today?"_
...
_"Yes, you have a meeting with Dr. Chuck at 4:00 PM."_
...
_“Do I have any meeting tomorrow?”_

It replies:

_"No, you do not have any meetings scheduled for tomorrow."_
